...
<section class="banner_part2">
        <div class="container">
                ...
                <div class="row justify-content-center" style="margin-top: 100px; padding-bottom: -20px;">
                <div class="col-xl-5">
                ...
                <!--div class="col-md-4 align-self-center">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="single_feature">
                            <div class="single_feature_part"><a href="htmlproject.php">
                            <span class="single_feature_icon"><i class="fa fa-html5" aria-hidden="true"></i></span>
                            <h4>HTML5</h4>
                            <p>Projects and assignments of HTML5 are available here.</p></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>My SQL</h4>
                            <p>Projects and assignments of MySQL are available here.</p></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2"><a href="htmlp1.php">
                            <span class="single_service_icon style_icon"><i class="fa fa-code" aria-hidden="true"></i></span>
                            <h4>Java Script</h4>
                            <p>Projects and assignments of Javascript are available here.</p></a> </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part"><a href="htmlp1.php">
                            <span class="single_feature_icon"><i class="fa fa-css3" aria-hidden="true"></i></span>
                            <h4>CSS</h4>
                            <p>Projects and assignments of CSS are available here.</p></a>
                        </div>
                    </div>
                </div>
            </div>
